...
public class User
{
	...
	public User(final int userId, final String userName, final String userRating, final int productId)
	{
		super();
		this.userId = userId;
	...
	{
		return "User [userId=" + this.userId + ", userName=" + this.userName + ", userRating=" + this.userRating + ", productId=" + this.productId + "]";
	}
}